  ...
  try {
    ...
    return {
      ...
      initial: {
        ...
        minNights: property.minNights != null ? String(property.minNights) : '',
        ...
        visitPrice:
          property.visitPrice != null ? String(property.visitPrice) : '',
...
export default async function AgentPropertyEditPage({
  params,
}: {
