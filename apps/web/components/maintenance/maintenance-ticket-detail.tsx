  ...
  return (
    <div className="space-y-6">
      ...
      <DetailHeader
        ...
        actions={
          <>
            <Link href={paths.edit(ticketId)}>
              <Button icon="mdi:pencil" variant="primary">
                Modifier
              </Button>
            </Link>
            <Link href={paths.list}>
        ...
        <div className="space-y-6">
          <DetailCard title="Informations">
            ...
            <DetailRow
              ...
              value={
                <Link
                  href={paths.property(ticket.propertyId)}
