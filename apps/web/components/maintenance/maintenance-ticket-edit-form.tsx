...
export interface MaintenanceTicketEditFormProps {
  ticketId: string;
  role?: 'owner' | 'agent';
}

export function MaintenanceTicketEditForm({
  ticketId,
  role = 'owner',
}: MaintenanceTicketEditFormProps): React.JSX.Element {
  ...
  const form = useResourceForm<FormValues>({
    ...
    onSubmit: async (values) => {
      ...
      router.push(paths.ticket(ticketId));
    },
  });
    ...
    <div className="space-y-6">
      <DashboardPageHeader
        ...
        breadcrumb={[
          ...
          { label: shortTitle, href: paths.ticket(ticketId) },
          { label: 'Modifier' },
        ]}
      />
        ...
        <FormCard
          ...
          footer={
            <FormFooter
              ...
              onCancel={() => router.push(paths.ticket(ticketId))}
