...
const AdvancedSearchForm = ({ title, actionText }) => {
    ...
    return (
        ...
        >
            ...
            <View className="px-4">
                {title && <Text className="text-center text-xl text-blue-900 font-bold my-3">{title}</Text>}
                <View className="space-y-4">

                    <View className="flex-row justify-center bg-gray-100 px-2 py-2 rounded-lg">
                        <TouchableOpacity 
                ...
                <View className="my-5">
                    <TouchableOpacity onPress={handleSubmit} className="bg-blue-500 rounded-xl p-4">
                        <Text className="text-center text-white text-base font-bold">{actionText}</Text>
                    </TouchableOpacity>
                </View>
            </View>
            )}
